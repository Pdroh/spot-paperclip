    ...
    <aside className="w-60 h-full min-h-0 border-r border-border bg-background flex flex-col">
      ...
      <nav className="flex-1 min-h-0 overflow-y-auto scrollbar-auto-hide flex flex-col gap-4 px-3 py-2">
        <div className="flex flex-col gap-0.5">
          ...
          <SidebarNavItem to="/dashboard" label="Inicio" icon={LayoutDashboard} liveCount={liveRunCount} />
          <SidebarNavItem
            to="/inbox"
        ...
        <SidebarSection label="Trabalho">
          ...
          {showWorkspacesLink ? (
            <SidebarNavItem to="/workspaces" label="Espacos de trabalho" icon={GitBranch} />
          ) : null}
        </SidebarSection>
        ...
        <SidebarSection label="Empresa">
          <SidebarNavItem to="/org" label="Equipe" icon={Network} />
